<x-layout>
    <x-settings heading="Manage Shifts">
        <div class="flex flex-col">
            <div class="my-2  sm:-mx-6 lg:-mx-14">
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @if (count($shifts))
                                    @foreach ($shifts as $shift)
                                        <!-- TODO: Fix the width (it goes out of div) -->
                                        <tr>
                    ...
                    <a href="/admin/shifts/create"><button class="mt-2 transition-colors duration-300 bg-blue-500 hover:bg-blue-600 rounded-full text-xs font-semibold text-white uppercase py-2 px-10">Create Shift</button></a>
                </div>
            </div>
        </div>
    </x-settings>
